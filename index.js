...
app.use(
  cors({
    origin: [
      "http://localhost:5173",
      "http://localhost:5174",
      "https://bistro-boss-client-6b726.web.app",
      "https://bistro-boss-client-6b726.firebaseapp.com",
    ],
    credentials: true,
  })
);
...
async function run() {
  try {
    ...
    app.post("/jwt", async (req, res) => {
      try {
        const user = req.body;
        console.log(user); // Check server logs to see if this prints correctly
